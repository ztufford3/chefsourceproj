<?php
	    ...
	    $result;
	    if($userid)
	    	$result = mysqli_query($con, "SELECT * FROM Requests WHERE userid='$userid'");
	    else
	    ...
	    foreach($arr as $request) {
	    	...
	    	array_push($itemsarr, $request['itemrequested'],$request['itemrequested2'],$request['itemrequested3'],$request['itemrequested4']);
